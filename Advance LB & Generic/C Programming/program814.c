// EncryptDecrypt.cpp file contains
...
extern "C" declspec(dllexport) void Encrypt_Ceaser_Cipher(char *Src , char *Dest , int Key)
// Ceaser Cipher
void Encrypt_Ceaser_Cipher(char *Src , char *Dest , int Key)
{
...
extern "C" declspec(dllexport) void Decrypt_Ceaser_Cipher(char *Src , char *Dest , int Key)

void Decrypt_Ceaser_Cipher(char *Src , char *Dest , int Key)
{
    int fdSrc = 0 , fdDest = 0;
    char Buffer[MAX_SIZE] = {'\0'};
    int iRet = 0 , i = 0;
...
extern "C" declspec(dllexport) void Encrypt_XOR_Cipher(char *Src , char *Dest , char Key)
...
extern "C" declspec(dllexport) void Decrypt_XOR_Cipher(char *Src , char *Dest , char Key)
