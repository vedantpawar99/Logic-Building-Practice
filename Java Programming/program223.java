...
//problem - solved occured to call the destructor
//problem - again solved occured to call the destructor
// making the array private, to keep the elements unchanged

import java.util.Scanner;

class NNumberX
{
    private int Arr[];                       //making the array private
...
class program223
{
    public static void main(String A[])
    {
        ...
        sobj = null;
        nobj = null;                //second problem solved of 221

        System.gc();                //garbage collectors request-problem solved
    }
}